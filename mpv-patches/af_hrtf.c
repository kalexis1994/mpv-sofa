...
// Headphone-EQ profile (declared early so struct priv can embed it).
// Implementation lives alongside the parser and process functions later.
...
// own frequency colouration.  HpEqProfile/HpEqBand/HpEqType are declared
// near struct priv so it can embed an instance by value.
// ---------------------------------------------------------------------------
