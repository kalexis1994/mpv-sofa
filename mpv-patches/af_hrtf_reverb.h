/*
 * Schroeder/Freeverb stereo reverb (8 parallel comb filters with one-pole
 * lowpass in feedback, 4 series allpass filters per ear, configurable
 * predelay and wet/dry mix).  Extracted from af_hrtf.c.
 *
...
#ifndef AF_HRTF_REVERB_H
#define AF_HRTF_REVERB_H
